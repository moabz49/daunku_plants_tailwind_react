...
const Care = () => {
  return (
    ...
    {/* Great use of Fade HEADER = "down", UPPER = "left", LOWER = "right" */}

      {/* Flex-col on smaller screens and on lg: flex-row  */}
            ...
            <FadeIn key={i} delay={(i + 1) * 0.2} direction="left">
              <div className='flex flex-col xs:flex-row gap-6 items-center xs:items-start'>
                ...
                <div>
                  ...
                  {/* Text size increase on :md viewport */}

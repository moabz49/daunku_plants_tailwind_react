...
const Footer = () => {
  return (
    <section className='bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]'>
      <div className='max-w-[1490px] mx-auto px-10 py-[120px]'>
        <div className='flex flex-col items-center xl:items-start xl:flex-row xl:justify-between gap-12'>
          <div className='w-full xl:w-auto mb-10 flex flex-col items-center xl:items-start'>
              ...
              <div className='relative w-full xs:w-[380px] xl:w-[320px] mt-11 '>
                ...
                />
                <div className='absolute top-2/4 -translate-y-2/4 right-2 bg-[linear-gradient(90deg,_#2AF598_0%,_#009EFD_100%)] px-6  py-2.5 rounded-full cursor-pointer text-white'>
                  Subscribe
                </div>
              </div>
          </div>
          {/* flex col items-center and then big device items-start  flex-row */}
        ...
        {/* Irrelevant to everything always remain at the bottom & is responsive compared to its own surrounding*/}
